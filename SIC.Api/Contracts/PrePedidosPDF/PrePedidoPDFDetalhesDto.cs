...
public sealed class PrePedidoPDFDetalhesDto
{
    ...
    public IReadOnlyList<PrePedidoPDFItemDto> Itens { get; set; } = [];
    public IReadOnlyList<PrePedidoPDFLogDto> Logs { get; set; } = [];
    public IReadOnlyList<PrePedidoPDFEnderecoDto> Enderecos { get; set; } = [];
    public IReadOnlyList<PrePedidoPDFLocalEntregaDto> LocaisEntrega { get; set; } = [];
    public IReadOnlyList<PrePedidoPDFCnpjDto> Cnpjs { get; set; } = [];
