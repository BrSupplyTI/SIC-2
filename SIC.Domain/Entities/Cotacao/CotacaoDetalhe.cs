...
/// <summary>
/// Dados completos de uma proposta de cotação (DetalheSql + dados do atendente).
/// </summary>
public sealed class CotacaoDetalhe
{
    ...
    // Preenchido por consulta auxiliar (fn_BR_ValidaCredito)
    public string StatusCredito { get; set; } = string.Empty;

    // Preenchido por consulta auxiliar (BR_Usuario do atendente)
    ...
    public IReadOnlyList<CotacaoDetalheItem> Itens { get; set; } = [];
}
