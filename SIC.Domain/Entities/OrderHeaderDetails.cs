...
public sealed class OrderHeaderDetails
{
    ...
    public DateTime? DtProgEmbarque { get; set; }
    public DateTime? DtProgEntrega { get; set; }
    public DateTime? DtPlanejadaOperacao { get; set; }
    public DateTime? DtSLACliente { get; set; }
    public DateTime? DtProgEmbFollow { get; set; }
    public string FreteAgrupado { get; set; } = string.Empty;
    public string ObsCalcFrete { get; set; } = string.Empty;
    public DateTime? DtPrevEntFollow { get; set; }
