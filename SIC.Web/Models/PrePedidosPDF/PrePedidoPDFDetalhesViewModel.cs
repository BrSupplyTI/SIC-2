...
/// <summary>
/// ViewModel da página de detalhes do pré-pedido (findByID).
/// </summary>
public sealed class PrePedidoPDFDetalhesViewModel
{
    ...
    public IReadOnlyList<PrePedidoPDFItemViewModel> Itens { get; set; } = [];
    public IReadOnlyList<PrePedidoPDFLogViewModel> Logs { get; set; } = [];
    public IReadOnlyList<PrePedidoPDFEnderecoViewModel> Enderecos { get; set; } = [];
    public IReadOnlyList<PrePedidoPDFLocalEntregaViewModel> LocaisEntrega { get; set; } = [];
    public IReadOnlyList<PrePedidoPDFCnpjViewModel> Cnpjs { get; set; } = [];
