document.addEventListener('DOMContentLoaded', function () {
    ...
    function initSearchableSelect(select) {
        ...
        tomSelectInstances.push(new TomSelect(select, {
            create: false,
    ...
    // ── Trocar Item ──
    if (trocarItemModal) {
        trocarItemModal.addEventListener('show.bs.modal', async function (event) {
            ...
            // Load substitute items via AJAX
        ...
        // Update hidden inputs on substitute select change
        document.getElementById('itemSubstituto').addEventListener('change', function () {
            var opt = this.selectedOptions[0];
            if (opt && opt.value) {
                document.getElementById('cdItemNovo').value = opt.value;
                document.getElementById('itemIDNovo').value = opt.dataset.itemId || '';
                document.getElementById('nmItemNovo').value = opt.dataset.nmItem || '';
                document.getElementById('tblPrecoNovo').value = opt.dataset.vlrTabelaPreco || '';
            } else {
                document.getElementById('cdItemNovo').value = '';
                document.getElementById('itemIDNovo').value = '';
                document.getElementById('nmItemNovo').value = '';
