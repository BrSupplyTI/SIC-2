...
/// <summary>
/// ViewModel para representar um item individual da Proposta/Cotação.
/// Usado na grid de produtos da tela de visualização.
/// </summary>
public sealed class CotacaoItemViewModel
{
    ...
    public string UnidadeMedidaDescricao { get; set; } = string.Empty;
    ...
    public string TipoCusto { get; set; } = "A";
    ...
    public bool PermiteTrocarMarca { get; set; }
    public bool PermiteTrocarUnidade { get; set; }
