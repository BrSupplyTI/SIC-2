...
public interface IUserProfileService
{
    ...
    Task<OperationResult> UpdateProfileAsync(int usuarioId, int? areaId, string? telefone, string? ramal, int? matricula, string? cargo, string? setor, int? diaAniversario, int? mesAniversario, CancellationToken cancellationToken = default);
