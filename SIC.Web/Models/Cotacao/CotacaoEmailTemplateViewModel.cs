...
/// <summary>
/// Template de e-mail com todos os dados necessários para renderizar o HTML da cotação.
/// </summary>
public sealed class CotacaoEmailTemplateViewModel
{
    ...
    public IReadOnlyList<CotacaoEmailTemplateItemViewModel> Itens { get; set; } = [];
}
