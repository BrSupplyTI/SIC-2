...
public sealed class SqlUserProfileRepository(IConfiguration configuration) : IUserProfileRepository
{
    ...
    public async Task<UserProfile?> GetProfileAsync(int usuarioId, CancellationToken cancellationToken = default)
    {
        ...
        return new UserProfile
        {
            ...
            DiaAniversario = ReadNullableInt(reader, "DiaAniversario"),
            MesAniversario = ReadNullableInt(reader, "MesAniversario"),
    ...
    public async Task<bool> UpdateProfileAsync(int usuarioId, int? areaId, string? telefone, string? ramal, int? matricula, string? cargo, string? setor, int? diaAniversario, int? mesAniversario, CancellationToken cancellationToken = default)
    {
        const string sql = """
            UPDATE BR_Usuario
        ...
        cmd.Parameters.AddWithValue("@diaAniversario", diaAniversario.HasValue ? diaAniversario.Value : DBNull.Value);
        cmd.Parameters.AddWithValue("@mesAniversario", mesAniversario.HasValue ? mesAniversario.Value : DBNull.Value);
